...
> **Nota.** Este proyecto está aquí como referencia. La prioridad del
> repositorio es la réplica local de Habbo, que se monta desde la raíz
> (ver el [README principal](../README.md)). Los dos son independientes:
> este juego es arte y código originales, y sigue funcionando por su cuenta.
